...
//  «Минимальная сумма трат за день составила … рублей. Максимальная сумма трат за день составила … рублей».
        ...
        int maxAmount = arr[0]; // минимальное число - 1, с которым будут сравниваться все элементы для выявления максимальной суммы
        int minAmount = arr[0]; // максимальное число + 1, с которым будут сравниваться все элементы для выявления минимальной суммы
        for (int i : arr) {
            if (i > maxAmount) {
                maxAmount = i;
            }
